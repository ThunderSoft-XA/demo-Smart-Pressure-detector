...
* @{
*/
#define PRODUCT_KEY "6ce94ddc913e4a5aba1056dd1373456a"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "98e7177919a3441ea5c548eedc2b8fa3"
...
* @{
*/
#define LedValue_BYTEOFFSET                    0
#define LedValue_BITOFFSET                     0
#define LedValue_LEN                           1
#define MotorValue_BYTEOFFSET                    0
#define MotorValue_BITOFFSET                     1
#define MotorValue_LEN                           1
